          ...
          <div className="modal-body p-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <div className="mb-3">
                  <label htmlFor="number" className="block mb-1">จำนวน: <span className="text-red-500">*</span></label>
                  <input
                    id="number"
                    type="number"
                    className="w-full p-2 border rounded"
              ...
              <div>
                ...
                <div className="mb-3 ml-20">
                  <label htmlFor="weight" className="block mb-1">ชื่อผู้รับ : MN1688</label>
                </div>
                <div className="mb-3 ml-20">
                  <label htmlFor="wide" className="block mb-1">ที่อยู่ : 广东省广州市白云区白云湖街道夏茅南约商业街18号9号仓1109-1 PLMCARGO 仓库 (MN1688)</label>
                </div>
                <div className="mb-3 ml-20">
                  <label htmlFor="high" className="block mb-1">รหัสไปรษณีย์ : 510440</label>
                </div>
                <div className="mb-3 ml-20">
                  <label htmlFor="long" className="block mb-1">เบอร์ติดต่อ : 13268241999</label>
                </div>
              </div>
            </div>
          </div>
